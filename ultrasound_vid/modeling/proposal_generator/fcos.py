...
from ultrasound_vid.modeling.layers import DFConv2d, NaiveGroupNorm
...
class FCOS(nn.Module):
    ...
    def forward(self, images, features, gt_instances=None, top_module=None):
        ...
        results = self.fcos_outputs.predict_proposals(
            logits_pred, reg_pred, ctrness_pred, locations, images.image_sizes, top_feats,
        )
        return results, {}
